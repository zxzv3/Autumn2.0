...
<body>
	...
	<div class="warpper">
		...
		<div class="box fl">
			<h1>用户设置</h1>
			<table class="table-list setting" style="min-width:1000px;">
				<tr>
					<th width="190">配置项名称</th>
					<th width="350">配置项值</th>
					<th width="220">关联用户权限组</th>
	...
	<script type="text/dom">
		var create-setting = <div class="create-setting" api-name="User_setting/Create">
			...
			<select api-param-name="from_group">
				<option value="-1">不关联用户权限组</option>
				{Group_list}
		...
		var edit-setting = <div class="edit-setting" api-name="User_setting/Edit">
	...
	<script type="text/javascript">
		...
		// 	$(".table-list .tr").each(function(key , value){
		// 		var $this = $(value).attr('data-data')
		// 	})
		// })
		var timeout = 0;
		$("input[type='text']").bind("propertychange input" , function(){
			...
			timeout = setTimeout(function(){
				ApiRequest.push('User_setting/Edit_item' , {
					params : {
						id : data.id,
						value : $this.val()
					},
		...
		$(".fa-trash-o").click(function(){
			var data = $.parseJSON($(this).parent().parent().attr('data-data'));
			ApiRequest.push('User_setting/Remove' , {params : {id : data.id}})
		})
		$(".fa-edit").click(function(){
			...
			popup.sure({
				...
				ApiRequest.push('User_setting/Edit' , {params : {id : data.id}})
			});
		...
		$("#js-create-setting").click(function(){
			popup.sure({
				...
				ApiRequest.push('User_setting/Create')
			});
